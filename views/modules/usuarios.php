                    ...
                    <div class="card">
                        <div class="card-body ">
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="button" class="btn btn-success d-md-block mb-3" data-bs-toggle="modal" data-bs-target="#modalAgregarUsuario"><i class="fas fa-user-plus"></i> Agregar Usuario</button>
                                <button type="button" class="btn btn-success d-md-block mb-3" data-bs-toggle="modal" data-bs-target="#modalCargarCSV"><i class="fas fa-user-plus"></i> CSV</button>
                            </div>
...
<div class="modal fade " id="modalAgregarUsuario" tabindex="-1" aria-labelledby="myLargeModalLabel" style="display: none;" aria-hidden="true" role="dialog">
      ...
      <div class="modal-body">
        <form id="formCSV" method="post" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <div id="dropzoneCSV" class="border border-primary border-2 rounded p-4 text-center bg-light" style="cursor: pointer;">
              <i class="fas fa-cloud-upload-alt fa-3x mb-2 text-primary"></i>
              <p id="fileLabel">Ningún archivo seleccionado</p>
              <input type="file" name="archivo_csv" id="archivo_csv" accept=".csv" style="display: none;" required>
            </div>
          </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label"><i class="fas fa-lock"></i> Password</label>
                        <input type="password" class="form-control" id="editar_password" name="editar_password" required>
                    </div>
                    <div class="mb-3">
                        <label for="perfil" class="form-label"><i class="fas fa-user-tag"></i> Perfil</label>
